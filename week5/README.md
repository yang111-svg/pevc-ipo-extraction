...
**方法**: PDF → PyMuPDF逐页文本 → 代码正则定位章节 → 规则提取候选事件 → 质量分级(high/medium/low)
...
| 对比项 | 刘宇轩V4 | 杨苗鑫Week5 |
|--------|----------|------------|
| Markdown解析 | ✅ 全量Markdown正则表格扫描 | ✅ PyMuPDF+代码定位 (MinerU ready) |
| 表格0 Token提取 | ✅ 星图测控7股东100% | ✅ 规则提取候选事件 |
| Cross-check | ✅ 8家Excel含3_schema_cross_check | ✅ 含完整数字(上一时点/变化量/预期/PDF/差额) |
